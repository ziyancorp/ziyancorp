#!/usr/bin/env python3
"""
AbangJal Distribution Agent - eksekusi distribusi ke YT, FB, IG, Threads (PUBLIK).
...
def main():
    ...
    if video_local:
        ...
        yt_desc = f"Produk fashion AbangJal.\n\nBeli di Shopee: {shopee}" if shopee else "Produk fashion AbangJal."
