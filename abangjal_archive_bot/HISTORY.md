# AbangJal ARSIP BOT — Dokumentasi Pencapaian
...
abangjal_bot/bot.py  (ArchiveBot)
...
**Lokasi:**
- Repo: `C:\Users\arija\abangjalcorp\abangjal_archive_bot\`
...
```bash
cd C:\Users\arija\abangjalcorp\abangjal_archive_bot
...
env -u PYTHONPATH ./venv/Scripts/python.exe -m abangjal_bot.bot
```

### Cek Instance (hindari orphan)
```powershell
Get-CimInstance Win32_Process | Where-Object { $_.CommandLine -like '*abangjal_bot.bot*' }
```
...
### Cron
- Job `abangjal-distribute-4x` (d9ee27fe41c3)
